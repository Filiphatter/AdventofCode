...
for i in range(1000000): #generates i up to 1m 
    ...
    if encodedInput.startswith('00000'): #if first 5 digits is 00000 it prints which iteration for the solution
        print(i)
        break

    #Did not beat this one on my own due to just brutal confusion